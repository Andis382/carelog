...
public final class AuthDtos {
    ...
    /** The phone is how the circle reaches a member on WhatsApp (summaries, swap requests, alerts). */
    public record UpdateProfileRequest(
        @NotBlank @Size(max = 120) String name,
        @Size(max = 40) String phone,
        @Pattern(regexp = "en|sq") String locale) {}

    public record UserView(Long id, String name, String email, String phone, String role, String locale) {
        public static UserView of(User u) {
            return new UserView(u.getId(), u.getName(), u.getEmail(), u.getPhone(), u.getRole().name(), u.getLocale());
        }
    }
