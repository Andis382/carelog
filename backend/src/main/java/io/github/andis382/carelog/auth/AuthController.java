...
import io.github.andis382.carelog.auth.AuthDtos.InvitationInfo;
import io.github.andis382.carelog.auth.AuthDtos.JoinRequest;
import io.github.andis382.carelog.auth.AuthDtos.LoginRequest;
import io.github.andis382.carelog.auth.AuthDtos.MeResponse;
import io.github.andis382.carelog.auth.AuthDtos.OrganizationView;
import io.github.andis382.carelog.auth.AuthDtos.RegisterRequest;
import io.github.andis382.carelog.auth.AuthDtos.UpdateProfileRequest;
import io.github.andis382.carelog.auth.AuthDtos.UserView;
...
public class AuthController {
    ...
    public AuthController(AuthenticationManager authenticationManager, SessionLogin sessionLogin, UserRepository users,
                          ...
                          PasswordEncoder passwordEncoder, CurrentUser currentUser, CircleService circle, AppProperties props,
                          Clock clock) {
    ...
    public MeResponse join(@Valid @RequestBody JoinRequest req, HttpServletRequest request, HttpServletResponse response) {
        ...
        Organization org = organizations.findById(inv.getOrganizationId()).orElseThrow();
        circle.requireSeatToJoin(org.getId());
